...
fn main() {
    ...
    // Only configure XLL output on Windows + MSVC
    if target_os != "windows" || target_env != "msvc" {
        // Non-Windows targets: skip XLL linking, but allow cargo check/test to run.
        // rusqlite bundled works on Linux/Mac for testing logic without Excel.
        return;
    }
